...
public class ProgramState {
  ...
  public static final ProgramState EMPTY_STATE = new ProgramState(
    ...
    PCollections.<SymbolicValue, PMap<Class<? extends Constraint>, Constraint>>emptyMap()
      ...
      .put(SymbolicValue.TRUE_LITERAL, PCollections.<Class<? extends Constraint>, Constraint>emptyMap().put(BooleanConstraint.class, BooleanConstraint.TRUE))
      .put(SymbolicValue.FALSE_LITERAL, PCollections.<Class<? extends Constraint>, Constraint>emptyMap().put(BooleanConstraint.class, BooleanConstraint.FALSE)),
    PCollections.emptyMap(),
  ...
  private static boolean isDisposable(SymbolicValue symbolicValue, @Nullable Constraint constraint) {
    return SymbolicValue.isDisposable(symbolicValue) &&
      (constraint == null ||
        !(constraint instanceof UnclosedResourcesCheck.ResourceConstraint || constraint instanceof CustomUnclosedResourcesCheck.CustomResourceConstraint));
  }
