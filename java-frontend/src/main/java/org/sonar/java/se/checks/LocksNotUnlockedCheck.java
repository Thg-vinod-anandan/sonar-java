...
public class LocksNotUnlockedCheck extends SECheck {
  ...
  private enum LockConstraint implements Constraint {
    LOCKED, UNLOCKED;
  ...
  public void checkEndOfExecutionPath(CheckerContext context, ConstraintManager constraintManager) {
    ...
    context.getState().getValuesWithConstraints(LockConstraint.LOCKED).stream()
      .flatMap(sv -> FlowComputation.flow(node, sv, LockConstraint.LOCKED::equals, LockConstraint.UNLOCKED::equals).stream())
