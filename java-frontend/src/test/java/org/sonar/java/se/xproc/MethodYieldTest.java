...
public class MethodYieldTest {
  ...
  public void flow_is_empty_when_yield_has_no_behavior() {
    MethodYield methodYield = new HappyPathYield(1, false, mock(ExplodedGraph.Node.class), null);
    assertThat(methodYield.flow(0)).isEmpty();
  }
  ...
  public void test_yield_equality() {
    ...
    otherYield = new HappyPathYield(1, false, new ExplodedGraph.Node(null, null), new MethodBehavior(null));
